import { BigintIsh, Token } from '@atleta-chain/sdk-core'
import { Interface } from '@ethersproject/abi'
import ISelfPermit from '@atleta-chain/v3-periphery/artifacts/contracts/interfaces/ISelfPermit.sol/ISelfPermit.json'
